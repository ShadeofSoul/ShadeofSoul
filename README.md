...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,scss,react,vite,ts,firebase,vscode,git,mui,tailwind,bootstrap,jquery,figma,matlab,visualstudio,cpp,c,linux,vim,bash,jupyter)](https://skillicons.dev)
